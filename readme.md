<h1>Square Space</h1>
<p>Square Space is a real time puzzle game for <a href="https://play.date" target="_blank">Playdate</a>, where you need to build the shape to finish the puzzle and pass to the next level. Each time it will be more complicated, so try to beat your high score!</p>
<p>If you fail there is a second chance.. with a twist.</p>
<p>There is also a zen mode for a stress free experience.<br><br></p>
